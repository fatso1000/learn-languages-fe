...
import { continueOrFailStrikesServer } from "@/actions/auth";
import { FireIconSolid, SuccessIconCircle } from "@/components/Icons";
import { hasOneDayPassed, isSameDay } from "@/shared/helpers";
import { IStrikes } from "@/types/generics";
...
const StrikesDays = memo(function StrikesDays(props: { strikes?: IStrikes }) {
  ...
  const todayIndex = isLastStrikeToday ? currentDate + 1 : currentDate;
      ...
      >
        <div className="inline-flex justify-between items-center">
          <h5 className="font-black text-xl">
            {strikes?.strikes_length || 0} {t("strike")}
          </h5>
          <FireIconSolid />
        </div>
